...
def build_metadata_change_log_event(msg: Any) -> MetadataChangeLogClass:
    # TODO: Map MCL to MetadataChangeLogClass
    value: dict = msg.value()
    return MetadataChangeLogClass.from_obj(post_json_transform(value), True)
...
def build_entity_change_event(payload: GenericPayloadClass) -> EntityChangeEventClass:
